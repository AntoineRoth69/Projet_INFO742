...
public class test {
	public static void main(String[] args) {
		...
		Conducteur conducteur_1 = new Conducteur("Antoine","rue du pont de thé Annecy","antoine",true,good, voiture_1);
		Conducteur conducteur_2 = new Conducteur("Lucas","rue du pont de thé Annecy","lucas",true,good, voiture_2);
		User user_1 = new User("Eloise","rue du pont de thé Annecy","eloise",true,good);
